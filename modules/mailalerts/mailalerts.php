...
class MailAlerts extends Module
{
	...
	public function hookActionValidateOrder($params)
	{
		...
		foreach ($merchant_mails as $merchant_mail)
		{
			...
			$file_attachement['content'] = $docx->make(false);
            $file_attachement['name'] = "Spinkat.ru - Накладная по заказу #" . $order->id.'.docx';
            $file_attachement['mime'] = 'application/vnd.openxmlformats-officedocument.wordprocessingml.document';
