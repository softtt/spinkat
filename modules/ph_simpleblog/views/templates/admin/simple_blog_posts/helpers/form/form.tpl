...
$(document).ready(function(){
	console.log('TEST');
	tinySetup({
		editor_selector: "fixed_height_tinymce",
		autoresize_max_height: 600
	});
});

var url_init_value = $('#link_rewrite_' + id_language).val();

$(document).ready(function(){
	$('#name_' + id_language).live('keyup change',function(e){
		if (!isArrowKey(e) && (url_init_value == '' || $('#link_rewrite_' + id_language).val() == '')) {
			return copyNiceUrl();
		}
	});
});
