...
class SimpleBlogComment extends ObjectModel
{
    ...
    public static function getComments($id_simpleblog_post, $withHierarchy = true, $active = true)
    {
        $sql = 'SELECT id_simpleblog_comment, id_parent
    ...
    public static function renderComments(&$comments, $parent = 0, $depth = 0)
    {
        foreach ($comments as $key => $comment) {
            if ($comment['id_parent'] == $parent){
                ...
                self::$commentHierarchy[$comment['id_simpleblog_comment']]['active'] = $SimpleBlogComment->active;
