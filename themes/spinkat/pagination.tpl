        ...
        {if $start!=$stop}
            <ul class="pagination">
                {if $p != 1}
                    ...
                    <li id="pagination_previous{if isset($paginationId)}_{$paginationId}{/if}" class="col-md-2 pagination_previous">
                        <a class="light-button" {$no_follow_text} href="{$link->goPage($requestPage, $p_previous)}" rel="prev">
                            {l s='Previous'}
                        </a>
                    </li>
                {else}
                    <li id="pagination_previous{if isset($paginationId)}_{$paginationId}{/if}" class="col-md-2 disabled pagination_previous">
                        <span class="light-button disabled">
                            {l s='Previous'}
                        </span>
                    </li>
                {/if}
                <div class="col-md-8 pages">
                    <!-- <ul> -->
                        {if $start==3}
                            <li>
                                <a class="light-button" {$no_follow_text}  href="{$link->goPage($requestPage, 1)}">
                                    1
                                </a>
                            </li>
                            <li>
                                <a class="light-button" {$no_follow_text}  href="{$link->goPage($requestPage, 2)}">
                                    2
                                </a>
                            </li>
                        {/if}
                        ...
                        {section name=pagination start=$start loop=$stop+1 step=1}
                            {if $p == $smarty.section.pagination.index}
                                <li class="active current">
                                    <span class="light-button active current">
                                        {$p|escape:'html':'UTF-8'}
                                    </span>
                                </li>
                            {else}
                                <li>
                                    <a class="light-button" {$no_follow_text} href="{$link->goPage($requestPage, $smarty.section.pagination.index)}">
                        ...
                        {if $pages_nb>$stop+2}
                            ...
                            <li>
                                <a class="light-button" href="{$link->goPage($requestPage, $pages_nb)}">
                                    {$pages_nb|intval}
                                </a>
                            </li>
                        {/if}
                        ...
                        {if $pages_nb==$stop+2}
                            <li>
                                <a class="light-button" href="{$link->goPage($requestPage, $pages_nb-1)}">
                                    {$pages_nb-1|intval}
                                </a>
                            </li>
                            <li>
                ...
                {if $pages_nb > 1 AND $p != $pages_nb}
                    ...
                    <li id="pagination_next{if isset($paginationId)}_{$paginationId}{/if}" class="col-md-2 pagination_next">
                        <a class="light-button" {$no_follow_text} href="{$link->goPage($requestPage, $p_next)}" rel="next">
                            {l s='Next'}
                        </a>
                    </li>
                {else}
                    <li id="pagination_next{if isset($paginationId)}_{$paginationId}{/if}" class="col-md-2 disabled pagination_next">
                        <span class="light-button disabled">
                            {l s='Next'}
                        </span>
                    </li>
