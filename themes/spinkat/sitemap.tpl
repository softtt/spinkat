    ...
    <div id="listpage_content">
        ...
        <div class="col-xs-12 col-sm-12">
            <div class="sitemap_block box">
                ...
                <ul>
                    <li>
                        <a href="{$categoriescmsTree.link|escape:'html':'UTF-8'}"
                           title="{$categoriescmsTree.name|escape:'html':'UTF-8'}">
...
{else}
    ...
    <div class="row">
        {if isset($tag_links) && count($tag_links)}
            <div class="col-xs-12 col-sm-6">
                <div class="sitemap_block box tag-cloud">
                    <h3 class="page-subheading">{l s='Теги'}</h3>
                    {foreach from=$tag_links item=link key=name}
                        <a class="tag-element" href="{$link|escape:'html':'UTF-8'}">
                            <span class="tag-name">{$name|escape:'html':'UTF-8'}</span>
                        </a>
                    {/foreach}
                </div>
            </div>
