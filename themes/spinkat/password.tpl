...
<ul class="clearfix footer_links">
	<li><a class="light-button" href="{$link->getPageLink('authentication')|escape:'html':'UTF-8'}" title="{l s='Back to Login'}" rel="nofollow"><!-- <span><i class="icon-chevron-left"></i> -->{l s='Back to Login'}<!-- </span> --></a></li>
</ul>
