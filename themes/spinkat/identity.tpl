...
<ul class="footer_links clearfix">
	<li>
        <a class="light-button-no-red" href="{$link->getPageLink('my-account', true)}">
            {l s='Back to your account'}
        </a>
    </li>
	<li>
        <a class="light-button-no-red" href="{if isset($force_ssl) && $force_ssl}{$base_dir_ssl}{else}{$base_dir}{/if}">
            {l s='Home'}
        </a>
    </li>
</ul>
