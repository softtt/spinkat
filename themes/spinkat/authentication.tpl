...
{else}
	...
	<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="account-creation_form" class="std box">
		...
		<div class="account_creation">
			...
			<!-- <p class="required"><sup>*</sup>{l s='Required field'}</p> -->
			<div class="required form-group">
				<label for="name">{l s='First name'} <sup>*</sup></label>
				<input onkeyup="$('#name').val(this.value);" type="text" class="is_required validate form-control" data-validate="isName" id="name" name="name" value="{if isset($smarty.post.name)}{$smarty.post.name}{/if}" />
			</div>
			{*
			<div class="required form-group">
			...
			*}
			...
			<div class="required password form-group">
				...
				<span class="form_info">{l s='(Eight characters minimum)'}</span>
			</div>
<!-- 			<div class="form-group">
				<label>{l s='Date of Birth'}</label>
				<div class="row">
