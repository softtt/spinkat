...
<!-- MODULE Block cart -->
	<div class="shopping_cart clearfix">
		<a href="{$link->getPageLink($order_process, true)|escape:'html':'UTF-8'}" title="{l s='View my shopping cart' mod='blockcart'}" rel="nofollow" class="shopping_cart_link">
			<div class="shopping_cart_data">

				<div class="shopping_cart_label">
					<span class="cart_text">{l s='Cart' mod='blockcart'}</span>
...
{addJsDefL name=shippingCouldBeCalculated}{l s='Стоимость доставки можно рассчитать через раздел "Доставка и оплата"' mod='blockcart' js=1}{/addJsDefL}
