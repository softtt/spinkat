...
<div role="tabpanel" class="tab-pane" id="comments">
	{if $comments}
			...
			<div class="comment row" itemprop="review" itemscope itemtype="https://schema.org/Review">
				<div class="comment_author col-sm-2">
					...
					<div class="comment_author_infos">
						...
						<br>
						<em>{$comment.date_add|russian_month_date:'d F Y'}</em>
					</div>
		...
		<p class="align_center">
			<a id="new_comment_tab_btn" class="light-button open-comment-form" href="#new_comment_form">
			...
			<div class="row">
				...
				<div class="new_comment_form_content col-xs-12 col-sm-6">
					...
					<div id="new_comment_form_footer">
						...
						<p class="fr">
							<button id="submitNewMessage" name="submitMessage" type="submit" class="light-button">
