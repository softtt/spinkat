...
class AuthController extends AuthControllerCore
{
    protected function processSubmitAccount()
    {
        ...
        $email = Tools::getValue('email') ? Tools::getValue('email') : 'client_without_email@spinkat.ru';
        ...
        // $lastnameAddress = Tools::getValue('name');
        // $firstnameAddress = Tools::getValue('name');
        // $_POST['lastname'] = Tools::getValue('name', $lastnameAddress);
        $_POST['firstname'] = Tools::getValue('name');
        ...
        if (!count($this->errors))
        {
            ...
            if (!count($this->errors))
            {
                ...
                // In order to allow customers without email make orders we set dummy email address for empty email
                // $email = Tools::getValue('email') ? Tools::getValue('email') : 'client_without_email@spinkat.ru';
