...
<div class="panel">
	...
	<div class="form-group">
		<!-- <div class="col-lg-1"><span class="pull-right">{include file="controllers/products/multishop/checkbox.tpl" field="show_on_sales_page" type="default"}</span></div> -->
		<!-- <label class="control-label col-lg-2" for="show_on_sales_page">&nbsp;</label> -->
		<div class="col-lg-12">
			<div class="checkbox">
				<label class="control-label" for="show_on_sales_page" >
					<input type="checkbox" name="show_on_sales_page" id="show_on_sales_page" {if $product->show_on_sales_page}checked="checked"{/if} value="1" />
					{l s='Display product on Sales page (only if it has specific price).'}
				</label>
			</div>
		</div>
	</div>
		...
		<div class="col-lg-12">
			...
			<div class="form-group">
				...
				<div class="col-lg-4">
					...
					{foreach from=$combinations item='combination'}
						<option value="{$combination.id_product_attribute}">{$combination.attributes}{' '}{$combination.reference}</option>
					{/foreach}
					</select>
				</div>
			</div>
