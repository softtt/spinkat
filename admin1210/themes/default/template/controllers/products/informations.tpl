...
<div id="product-informations" class="panel product-tab">
	...
	<div id="product_options" class="form-group">
		<div class="col-lg-12">
			...
			<div class="form-group">
				<div class="col-lg-1"><span class="pull-right">{include file="controllers/products/multishop/checkbox.tpl" field="is_series" type="radio" onclick=""}</span></div>
				<label class="control-label col-lg-2">
					{l s='Is series of products'}
				</label>
				<div class="col-lg-9">
					<span class="switch prestashop-switch fixed-width-lg">
						<input type="radio" name="is_series" id="is_series_on" value="1" {if $product->is_series}checked="checked" {/if} />
						<label for="is_series_on" class="radioCheck">
							{l s='Yes'}
						</label>
						<input type="radio" name="is_series" id="is_series_off" value="0" {if !$product->is_series || !$product->isAssociatedToShop()}checked="checked"{/if} />
						<label for="is_series_off" class="radioCheck">
							{l s='No'}
						</label>
						<a class="slide-button btn"></a>
					</span>
			...
			<div class="form-group">
				<div class="col-lg-1"><span class="pull-right">{include file="controllers/products/multishop/checkbox.tpl" field="is_new" type="radio" onclick=""}</span></div>
				<label class="control-label col-lg-2">
					{l s='Show as new'}
				</label>
				<div class="col-lg-9">
					<span class="switch prestashop-switch fixed-width-lg">
						<input type="radio" name="is_new" id="is_new_on" value="1" {if $product->is_new}checked="checked" {/if} />
						<label for="is_new_on" class="radioCheck">
							{l s='Yes'}
						</label>
						<input type="radio" name="is_new" id="is_new_off" value="0" {if !$product->is_new || !$product->isAssociatedToShop()}checked="checked"{/if} />
						<label for="is_new_off" class="radioCheck">
							{l s='No'}
						</label>
						<a class="slide-button btn"></a>
					</span>
			...
			<div class="form-group">
				<div class="col-lg-1"><span class="pull-right">{include file="controllers/products/multishop/checkbox.tpl" field="show_gift_label" type="radio" onclick=""}</span></div>
				<label class="control-label col-lg-2">
					{l s='+Подарок'}
				</label>
				<div class="col-lg-9">
					<span class="switch prestashop-switch fixed-width-lg">
						<input type="radio" name="show_gift_label" id="show_gift_label_on" value="1" {if $product->show_gift_label}checked="checked" {/if} />
						<label for="show_gift_label_on" class="radioCheck">
							{l s='Yes'}
						</label>
						<input type="radio" name="show_gift_label" id="show_gift_label_off" value="0" {if !$product->show_gift_label || !$product->isAssociatedToShop()}checked="checked"{/if} />
						<label for="show_gift_label_off" class="radioCheck">
							{l s='No'}
						</label>
						<a class="slide-button btn"></a>
					</span>
	...
	<div class="form-group">
		...
		<div class="col-lg-9">
			<textarea class="" id="video" name="video">{$product->video}</textarea>
		</div>
	</div>
				...
				{foreach from=$languages item=language}
					...
					<script type="text/javascript">
						$().ready(function () {
							...
							$('#'+input_id).tagify('inputField').autocomplete(availableTags);
