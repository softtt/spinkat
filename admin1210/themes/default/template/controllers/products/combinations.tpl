...
<div id="product-combinations" class="panel product-tab">
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			$('.panel-footer > button').click(function () {
				$('#combination_tags').tagify('serialize');
			});
			populate_attrs();
	...
	<div id="add_new_combination" class="panel" style="display: none;">
		...
		<div class="form-group">
			<label class="control-label col-lg-3" for="attribute_title">
				{l s='Title'}
			</label>
			<div class="col-lg-3">
				<input maxlength="250" type="text" id="attribute_title" name="attribute_title" value="" />
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<label class="control-label col-lg-3" for="attribute_short_description">
				{l s='Short description'}
			</label>
			<div class="col-lg-9">
				<textarea class="" id="attribute_short_description" name="attribute_short_description"></textarea>
			</div>
		</div>

		<div class="form-group">
			<label class="control-label col-lg-3" for="attribute_top_description">
				{l s='Top description'}
			</label>
			<div class="col-lg-9">
				<textarea class="combination_rte" id="attribute_top_description" name="attribute_top_description"></textarea>
			</div>
		</div>

		<div class="form-group">
			<label class="control-label col-lg-3" for="attribute_long_description">
				{l s='Long description'}
			</label>
			<div class="col-lg-9">
				<textarea class="combination_rte" id="attribute_long_description" name="attribute_long_description"></textarea>
			</div>
		</div>

		<div class="form-group">
			<label class="control-label col-lg-3" for="attribute_video">
				{l s='Video'}
			</label>
			<div class="col-lg-9">
				<textarea class="" id="attribute_video" name="attribute_video"></textarea>
			</div>
		</div>

		<div class="form-group">
			<div class="col-lg-1"><span class="pull-right">{include file="controllers/products/multishop/checkbox.tpl" field="attribute_is_new" type="attribute_is_new"}</span></div>
			<label class="control-label col-lg-2" for="attribute_is_new">
				{l s='Show as new'}
			</label>
			<div class="col-lg-9">
				<p class="checkbox">
				<label for="attribute_is_new">
					<input type="checkbox" name="attribute_is_new" id="attribute_is_new" value="1" />
				</label>
				</p>
			</div>
		</div>
		...
		<div class="form-group">
			<div class="col-lg-1"><span class="pull-right">{include file="controllers/products/multishop/checkbox.tpl" field="attribute_hide" type="attribute_hide"}</span></div>
			<label class="control-label col-lg-2" for="attribute_hide">
				{l s='Hide'}
			</label>
			<div class="col-lg-9">
				<p class="checkbox">
				<label for="attribute_hide">
					<input type="checkbox" name="attribute_hide" id="attribute_hide" value="1" />
				</label>
				</p>
			</div>
		</div>
			...
			<div class="col-lg-9">
				...
				<div class="row">
					...
					{literal}
						<script type="text/javascript">
							$().ready(function () {
								var input_id = '{/literal}combination_tags{literal}';
								$('#'+input_id).tagify({delimiters: [13,44], addTagPrompt: '{/literal}{l s='Добавить тег' js=1}{literal}'}).tagify('serialize');
									/*.autocomplete({
										source: function (){
											$.ajax({
												url: url,
					...
					{if $languages|count > 1}
						<div class="translatable-field lang-{$language.id_lang}">
							<div class="col-lg-9">
								{/if}
								<input type="text" id="combination_tags" class="tagify updateCurrentText" name="combination_tags" value="" />
								{if $languages|count > 1}
							</div>
							<div class="col-lg-2">
