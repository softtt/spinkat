			...
			<div class="panel">
				...
				<div class="well hidden-print">
					...
					{if Configuration::get('PS_INVOICE') && count($invoices_collection) && $order->invoice_number}
						<a data-selenium-id="view_invoice" class="btn btn-default _blank" href="{$link->getAdminLink('AdminDocx')|escape:'html':'UTF-8'}&amp;submitAction=generateInvoiceDocx&amp;id_order={$order->id|intval}">
							<i class="icon-file"></i>
							{l s='View invoice'}
						</a>
					{else}
