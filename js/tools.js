...
function fancyChooseBox(question, title, buttons, otherParams)
{
    ...
    for (var caption in buttons) {
	  ...
	  msg += '<button type="submit" class="light-button" style="margin-right: 5px;" value="true" onclick="' + action + '" >';
...
// Validate form field for custom modules
function validateField(field) {
    ...
    if (field.attr('data-validate')) {
    	if (field.hasClass('required') || (!field.hasClass('required') && field.val()))
